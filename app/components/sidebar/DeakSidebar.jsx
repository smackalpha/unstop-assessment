    ...
    <>
      <div className="flex flex-col justify-center items-center space-y-4 mb-8">
        ...
        <div
          ...
          style={{ width: "100px", height: "70px", padding: "10px 20px" }}
      ...
      <div className="flex flex-col justify-center items-center px-2 py-4  border-t-2 border-dotted border-black space-y-3 cursor-pointer">
        <span
          style={{
            color: "#D63500",
        ...
        <Image src={Admin} alt="Round" width={30} height={20} />
