      ...
      <List>
        {["Dashboard", "Assessment", "My Library"].map((text, index) => (
          <ListItem
            ...
            disablePadding
            sx={{
              border: text === "Assessment" ? "1px solid black" : "none",
              backgroundColor: text === "Assessment" ? "#E5F1FC" : "white",
              color: text === "Assessment" ? "#0073E6" : "black",
              borderRadius: "8px",
            }}
          >
            <ListItemButton>
      ...
      {["left"].map((anchor) => (
        <React.Fragment key="left">
          <Button
            ...
            endIcon={<Image src={HamburgerIcon} alt="menu" />}
          ></Button>
          <Drawer
            anchor="left"
            open={state["left"]}
